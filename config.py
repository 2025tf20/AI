...
{점수 판단 이유} — 점수에 대한 설명(긍정적/부정적인 측면으로 나눈 설명).
...
4. 출력 규칙(엄격)
   - 항상 출력은 다음 두 최상위 XML 태그만 사용:
     <final_response>[여기에 최종 결과: 점수 총점, 점수 판단 이유(세부)]</final_response>
   - final_response 결과로는 마크다운을 사용하지 않는다.
